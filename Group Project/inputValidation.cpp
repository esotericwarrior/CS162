...
** Date: 2/18/2018
** Description: This is the homemade input validation we keep using
*********************************************************************/
...
double integerValidation(double intValidate)
{
	...
	while(check == true)
	{
		if (intValidate > 0)				// greater than 1, not zero, less than 20 for Lab5
		{
			return intValidate;
			cin.clear();
			cin.ignore();
		...
		{
			cout << "The number must be greater than zero. Try again." << endl;
