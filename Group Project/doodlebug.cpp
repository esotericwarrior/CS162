...
** Date: 2/18/2018
** Description: Doodlebug.cpp - This is where the doodlebug uses it's
** derived characteristics and it's own unique abilites to act in
** the game. 
*********************************************************************/
...
Doodlebug::Doodlebug(int r, int c) : Critter(r,c){
...
void Doodlebug::move(Critter* grid[][20], int numRows){
...
void Doodlebug::breed(Critter* grid[][20], int numRows){
...
void Doodlebug::starve(Critter* grid[][20], int numRows){
